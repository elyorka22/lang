          ...
          child: Row(
            children: [
              AppAvatar(
                ...
                url: room.isGroup ? null : room.peer?.avatarUrl,
                size: 40,
                status: room.isGroup ? null : room.peer?.status,
            ...
            child: room.isLoading
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final prev = i > 0 ? room.messages[i - 1] : null;
                      final next = i < room.messages.length - 1
                          ? room.messages[i + 1]
                          : null;
                      ...
                      // Telegram: name on first in streak, avatar on last.
                      final showSender =
                          !mine && room.isGroup && !prevSame;
                      final showAvatar = !mine && !nextSame;
                      final sender = room.senderProfile(m.senderId);
                      ...
                      return _MessageBubble(
                        ...
                        senderAvatarName:
                            sender?.displayName ?? room.senderName(m.senderId),
...
class _MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final nameColor = AppAvatar.colorFor(
      senderAvatarName.isEmpty ? senderName : senderAvatarName,
    );
    ...
    final bubble = GestureDetector(
      ...
      child: Container(
        constraints: BoxConstraints(
          maxWidth: MediaQuery.of(context).size.width * (isMine ? 0.78 : 0.72),
        ),
        margin: EdgeInsets.only(
          top: showSender ? 6 : 2,
          bottom: showAvatar ? 6 : 2,
        ),
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.only(
            ...
            bottomLeft: Radius.circular(isMine ? 16 : (showAvatar ? 4 : 16)),
            bottomRight: Radius.circular(isMine ? (showAvatar ? 4 : 16) : 16),
          ),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    // Incoming: Telegram-style avatar to the left of the bubble.
    return Align(
        ...
        children: [
          if (showAvatar)
            Padding(
              ...
              child: AppAvatar(
                name: senderAvatarName.isEmpty ? senderName : senderAvatarName,
                url: senderAvatarUrl,
                size: _avatarSize,
              ),
            )
